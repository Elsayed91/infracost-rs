//! GCP Hyperdisk Extreme pricing (storage + provisioned IOPS)
//!
//! ```bash
//! INFRACOST_API_KEY=xxx cargo run --example gcp_hyperdisk_extreme
//! ```
...
async fn main() -> infracost_rs::Result<()> {
    ...
    println!("=== GCP Hyperdisk Extreme (storage + IOPS) ===\n");
